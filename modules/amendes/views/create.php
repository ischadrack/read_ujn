...
<head>
    ...
    <title>Gestion des Amendes & Pertes - Bibliothèque UN JOUR NOUVEAU</title>
...
<body
   ...
   <!-- Sidebar -->
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <select name="abonne_id" id="abonne_select" required class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-library-500 focus:border-transparent text-gray-900 dark:text-white">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select name="type" id="type_amende" required class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-library-500 focus:border-transparent text-gray-900 dark:text-white">
                            ...
                            <div>
                                ...
                                <select name="livre_id" id="livre_select" class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-library-500 focus:border-transparent text-gray-900 dark:text-white">
                            ...
                            <div id="montant_suggestions" class="hidden">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <button type="button" onclick="setMontant(500)" class="px-3 py-1 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-200 dark:hover:bg-gray-600 text-sm">500 FC</button>
                                    <button type="button" onclick="setMontant(1000)" class="px-3 py-1 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-200 dark:hover:bg-gray-600 text-sm">1000 FC</button>
                                    <button type="button" onclick="setMontant(2000)" class="px-3 py-1 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-200 dark:hover:bg-gray-600 text-sm">2000 FC</button>
                                    <button type="button" onclick="setMontant(5000)" class="px-3 py-1 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-200 dark:hover:bg-gray-600 text-sm">5000 FC</button>
                                </div>
                            </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <select name="emprunt_id" id="emprunt_select" class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-library-500 focus:border-transparent text-gray-900 dark:text-white">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                                <h4 class="font-medium text-gray-900 dark:text-white mb-3">Barème indicatif des amendes</h4>
                                <div class="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                                    <div class="flex justify-between">
                                        <span>Retard (par jour):</span>
                                        <span class="font-medium">100 FC</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span>Perte de livre:</span>
                                        <span class="font-medium">80% du prix</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span>Détérioration légère:</span>
                                        <span class="font-medium">30% du prix</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span>Détérioration grave:</span>
                                        <span class="font-medium">60% du prix</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="calculateur" class="hidden bg-blue-50 dark:bg-blue-900/30 rounded-lg p-4">
                                <h4 class="font-medium text-blue-900 dark:text-blue-100 mb-3">Calculateur automatique</h4>
                                <div id="calcul_retard" class="hidden">
                                    ...
                                    <input type="number" id="jours_retard" min="1" class="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-blue-300 dark:border-blue-600 rounded-md text-blue-900 dark:text-blue-100">
                                    <button type="button" onclick="calculerRetard()" class="mt-2 px-3 py-1 bg-blue-600 text-white rounded-md text-sm hover:bg-blue-700">
                                        Calculer
                                    </button>
                                </div>
                                <div id="calcul_perte" class="hidden">
                                    <div class="text-sm text-blue-800 dark:text-blue-200 mb-2">Prix du livre: <span id="prix_livre">0</span> FC</div>
                                    <button type="button" onclick="calculerPerte()" class="px-3 py-1 bg-blue-600 text-white rounded-md text-sm hover:bg-blue-700">
                                        Calculer 80% du prix
                                    </button>
                                </div>
                                <div id="calcul_deterioration" class="hidden">
                                    <div class="text-sm text-blue-800 dark:text-blue-200 mb-2">Prix du livre: <span id="prix_livre_det">0</span> FC</div>
                                    <div class="flex gap-2">
                                        <button type="button" onclick="calculerDeterioration(30)" class="px-3 py-1 bg-blue-600 text-white rounded-md text-sm hover:bg-blue-700">
                                            Légère (30%)
                                        </button>
                                        <button type="button" onclick="calculerDeterioration(60)" class="px-3 py-1 bg-blue-600 text-white rounded-md text-sm hover:bg-blue-700">
                                            Grave (60%)
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div id="info_abonne" class="hidden bg-yellow-50 dark:bg-yellow-900/30 rounded-lg p-4">
                                <h4 class="font-medium text-yellow-900 dark:text-yellow-100 mb-2">Informations sur l'abonné</h4>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex justify-between items-center">
                            ...
                            <div class="flex space-x-4">
                                <a href="index.php" class="px-6 py-3 border border-gray-300 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                    Annuler
                                </a>
    ...
    // Gestion de la sélection d'abonné - CORRECTION DU CHEMIN API
    document.getElementById('abonne_select').addEventListener('change', function() {
        const abonneId = this.value;
        
        if (abonneId) {
            // Charger les emprunts de cet abonné - CHEMIN CORRIGÉ
            ...
            if (abonne) {
                document.getElementById('abonne_details').innerHTML = `
                    <div>Nom: ${abonne.nom} ${abonne.prenom}</div>
                    <div>Classe: ${abonne.classe}</div>
                    <div>N° d'abonné: ${abonne.numero_abonne}</div>
                `;
