...
<body
    ...
    <div class="p-6">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-fredoka font-bold text-gray-900 dark:text-white">Modifier la Catégorie</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-2">Mettre à jour les informations de la catégorie</p>
            </div>
            <div class="flex space-x-3">
                <a href="view?id=<?php echo $categorie['id']; ?>" class="bg-gray-600 hover:bg-gray-700 text-white px-6 py-3 rounded-lg font-medium">
        ...
        <div class="mx-auto">
            <form method="POST" id="categorieForm" class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 space-y-6">
                <div>
                    ...
                    <input type="text" name="nom" required value="<?php echo htmlspecialchars($categorie['nom']); ?>"
                ...
                <div>
                    ...
                    <textarea name="description" rows="4" placeholder="Description de la catégorie..."
                              class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white"><?php echo htmlspecialchars($categorie['description']); ?></textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="age_minimum" required min="1" max="18" 
                               value="<?php echo $categorie['age_minimum']; ?>"
                               class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white">
                    ...
                    <div>
                        ...
                        <input type="number" name="age_maximum" required min="1" max="18" 
                               value="<?php echo $categorie['age_maximum']; ?>"
                               class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white">
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-4">
                        <input type="color" name="color" value="<?php echo $categorie['color']; ?>" 
                ...
                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            <div id="colorPreview" class="w-4 h-4 rounded-full" style="background-color: <?php echo $categorie['color']; ?>"></div>
                            <span id="namePreview" class="font-medium text-gray-900 dark:text-white"><?php echo htmlspecialchars($categorie['nom']); ?></span>
                        </div>
                        <div class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200">
                            ...
                            <span id="agePreview"><?php echo $categorie['age_minimum']; ?>-<?php echo $categorie['age_maximum']; ?> ans</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-4 border border-yellow-200 dark:border-yellow-700">
                    <div class="flex">
                        ...
                        <div>
                            <p class="text-sm text-yellow-800 dark:text-yellow-200 font-medium">Informations</p>
                            <p class="text-xs text-yellow-700 dark:text-yellow-300 mt-1">
                                Cette catégorie contient actuellement <?php echo $categorie['livres_count']; ?> livre(s).
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-end space-x-4">
                    <a href="view?id=<?php echo $categorie['id']; ?>" class="px-6 py-3 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-colors">
                        Annuler
                    </a>
