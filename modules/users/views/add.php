...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($error_message)) {
        ...
        if ($result['success']) {
            header('Location: view?id=' . $result['id'] . '&success=' . urlencode($result['message']));
            exit;
        } else {
...
<head>
    ...
    <title>Ajouter Utilisateur - Bibliothèque UN JOUR NOUVEAU</title>
        ...
        <header class="sticky top-0 z-50 bg-gradient-to-br from-library-50 to-blue-100 dark:from-gray-800 dark:to-gray-900 shadow-sm border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between h-16 px-6">
                <div class="flex items-center space-x-4">
                    ...
                    <h1 class="text-xl font-semibold text-gray-800 dark:text-white">Ajouter un Utilisateur</h1>
                </div>
        ...
        <div class="p-6">
            ...
            <nav class="flex mb-8" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Ajouter</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Créer un nouvel utilisateur</h2>
                    <p class="text-gray-600 dark:text-gray-400 mt-1">Saisissez les informations du nouvel utilisateur</p>
                </div>

                <form method="POST" enctype="multipart/form-data" class="p-6" id="addUserForm">
                    <!-- Section Photo -->
                    <div class="mb-8">
